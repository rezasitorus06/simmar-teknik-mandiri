...
<body>
    ...
    <footer id="kontak" class="bg-ink py-12 text-white">
        <div class="container-page flex flex-col justify-between gap-8 md:flex-row md:items-end">
            ...
            <div class="text-sm text-white/60 md:text-right"><p>Indonesia</p><p class="mt-1"><a href="mailto:simmarteknikmandiri@gmail.com" class="transition hover:text-lime">simmarteknikmandiri@gmail.com</a> &middot; WhatsApp tersedia untuk konsultasi</p></div>
        </div>
    </footer>
</body>
</html>
